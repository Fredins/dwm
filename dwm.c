 ...
 * allowed to select for this event mask.  The event handlers of dwm are organized in an array which is accessed whenever a new event has been fetched. This allows event dispatching
 * in O(1) time.
 *
